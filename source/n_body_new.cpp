...
void rhs(double r[][3], double v[][3], double ro[][3], double vo[][3],double * mass, double * eta, int N, double * radii, double * Prot, double * k2)
{
  ...
  //  printf ("floatk: %12.11f %12.11f %12.11f %12.11f %12.11f %12.11f %12.11f\n", vo[1][0], vo[1][1], vo[1][2], temp1, r1[0][1][0], r1[0][1][1], r1[0][1][2]);

  vo[1][0] += C[0] * (1 + mass[1]/mass[0]) * (-1*nu[0]*nu[0]) * (-12*mass[1]/(pow(temp1, 3))) * r1[0][1][0];
  vo[1][1] += C[0] * (1 + mass[1]/mass[0]) * (-1*nu[0]*nu[0]) * (-12*mass[1]/(pow(temp1, 3))) * r1[0][1][1];
  vo[1][2] += C[0] * (1 + mass[1]/mass[0]) * (-1*nu[0]*nu[0]) * (-12*mass[1]/(pow(temp1, 3))) * r1[0][1][2];
    

  vo[1][0] += C[1] * (1 + mass[0]/mass[1]) * (-1*nu[1]*nu[1]) * (-12*mass[0]/(pow(temp1, 3))) * r1[0][1][0];
  vo[1][1] += C[1] * (1 + mass[0]/mass[1]) * (-1*nu[1]*nu[1]) * (-12*mass[0]/(pow(temp1, 3))) * r1[0][1][1];
  vo[1][2] += C[1] * (1 + mass[0]/mass[1]) * (-1*nu[1]*nu[1]) * (-12*mass[0]/(pow(temp1, 3))) * r1[0][1][2];
